            ...
            <div class="container mx-auto max-w-4xl px-6 py-10">
                ...
                <div class="mt-12 space-y-8">
                    ...
                    <div class="rounded-lg border-2 border-gray-100 dark:border-gray-700">
                        ...
                        <p class="dropdown p-8 text-sm text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit, amet
                            consectetur adipisicing elit. Voluptas eaque nobis, fugit odit omnis fugiat deleniti animi ab
                            maxime cum laboriosam recusandae facere dolorum veniam quia pariatur obcaecati illo ducimus?</p>
                    </div>
                    ...
                    <div class="rounded-lg border-2 border-gray-100 dark:border-gray-700">
                        ...
                        <p class="dropdown1 p-8 text-sm text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit, amet
                            consectetur adipisicing elit. Voluptas eaque nobis, fugit odit omnis fugiat deleniti animi ab
                            maxime cum laboriosam recusandae facere dolorum veniam quia pariatur obcaecati illo ducimus?</p>
                    </div>
                    ...
                    <div class="rounded-lg border-2 border-gray-100 dark:border-gray-700">
                        <button class="icon2 flex w-full items-center justify-between p-8">
                            <h1 class="font-semibold text-gray-700 dark:text-white">Can you deliver even if we are living
                                abroad?</h1>
                        ...
                        <p class="dropdown2 p-8 text-sm text-gray-500 dark:text-gray-300">Absolutely Yes!!! Order now and
                            you will get it in just a second.</p>
                    </div>

                    <div class="rounded-lg border-2 border-gray-100 dark:border-gray-700">
                        <button class="icon3 flex w-full items-center justify-between p-8">
                            <h1 class="font-semibold text-gray-700 dark:text-white">Can you still deliver even if i'm up in
                                the mountain?</h1>
                        ...
                        <p class="dropdown3 p-8 text-sm text-gray-500 dark:text-gray-300"> Absolutely Yes!!! Order now and
                            you will get it in just a second.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div
                            ...
                            <form class="mt-6">
                                ...
                                <button
                                    ...
                                    <a href="mailto:abc@example.com?subject = Feedback&body = Message">get in
                                        touch</a></button>
                            </form>
                        </div>
                    </div>
            ...
            <div class="container mx-auto px-6 py-12">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <div class="mt-5 flex flex-col items-start space-y-2">
                            ...
                            <a href="#"
                                ...
                                Technology</a>
                            <a href="#"
                                class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">Franchising</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-5 flex flex-col items-start space-y-2">
                            <a href="#"
                                class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">lorem</a>
                            <a href="#"
                                class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">lorem</a>
                            <a href="#"
                                class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">Coffee
                                Creation</a>
                        </div>
                    </div>
                ...
                <div class="flex flex-col items-center justify-between sm:flex-row">
                    <a href="#"
                        class="text-2xl font-bold text-gray-800 transition-colors duration-300 hover:text-gray-700 dark:text-white dark:hover:text-gray-300"><img
