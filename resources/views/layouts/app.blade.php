...
<body>
    <div id="app">
        ...
        <header class="text-gray-100 bg-gray-900 body-font shadow w-full">
            <div
                class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
                <a
                    ...
                    <img src="{{ asset('images/Logostroke.png') }}" style="height: 50px" alt="logo">
