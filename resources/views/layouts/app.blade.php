...
<!-- Dark Header component -->
 <!-- Fontswesome -->
    ...
    <header class="text-gray-100 bg-gray-900 body-font shadow w-full">
        <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
            <a
            ...
            <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">
                      <div class="px-2 py-2 bg-white rounded-md shadow text-black opacity-80">
        ...
        <main class="py-4 bg-gray-700" style="background-image: url('{{ asset('images/bg-hidden.png') }}');background-size:cover;background-position:center">
            @yield('content')
        </main>
    </div>
